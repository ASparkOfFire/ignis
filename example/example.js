...
var require_parse = __commonJS({
    "node_modules/protobufjs/src/parse.js"(exports2, module2) {
        ...
        function parse(source, root2, options) {
            ...
            var head = true, pkg2, imports, weakImports, syntax, isProto3 = false;
            var ptr = root2;
...
var protobuf = import_protobufjs.default;
...
var FDResponse = root.lookupType("FDResponse");
var HeaderFields = root.lookupType("HeaderFields");
function marshalFDResponse(data) {
    ...
    const buffer = FDResponse.encode(message).finish();
    return buffer;
}
...
function example() {
    const testData = {
        Body: new Uint8Array(new TextEncoder().encode("Hello, World!")),
        StatusCode: 200,
        Length: 13,
        Header: {
            "content-type": {
